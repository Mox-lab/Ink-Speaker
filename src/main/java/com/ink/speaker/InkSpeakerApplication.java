...
@MapperScan(basePackages = "com.ink.speaker.**.mapper")
public class InkSpeakerApplication {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication app = new SpringApplication(InkSpeakerApplication.class);
