...
import com.ink.speaker.ai.domain.agent.ChapterRequest;
import com.ink.speaker.ai.domain.agent.ChapterResponse;
import com.ink.speaker.ai.domain.agent.CharacterExtractRequest;
import com.ink.speaker.ai.domain.agent.CharacterProfile;
import com.ink.speaker.ai.domain.agent.ChatReply;
import com.ink.speaker.ai.domain.agent.ChatRequest;
import com.ink.speaker.ai.domain.agent.ConceptRequest;
import com.ink.speaker.ai.domain.agent.ConceptResponse;
import com.ink.speaker.ai.domain.agent.LoreImportRequest;
import com.ink.speaker.ai.domain.agent.LoreImportResponse;
import com.ink.speaker.ai.domain.agent.LoreRequest;
import com.ink.speaker.ai.domain.agent.LoreResponse;
import com.ink.speaker.ai.domain.agent.LoreSearchHit;
import com.ink.speaker.ai.domain.agent.LoreSearchRequest;
import com.ink.speaker.ai.domain.agent.OutlineRequest;
import com.ink.speaker.ai.domain.agent.OutlineResponse;
import com.ink.speaker.ai.domain.agent.PolishRequest;
import com.ink.speaker.ai.domain.agent.PolishResponse;
import com.ink.speaker.ai.domain.agent.SettingRequest;
import com.ink.speaker.ai.domain.agent.SettingResponse;
import com.ink.speaker.ai.domain.agent.SkillInfo;
import com.ink.speaker.ai.domain.agent.SkillPreviewRequest;
import com.ink.speaker.ai.domain.agent.WritingRequest;
import com.ink.speaker.ai.domain.agent.WritingResponse;
import com.ink.speaker.ai.agent.ChapterAgentFactory;
import com.ink.speaker.ai.agent.CharacterExtractionAgent;
import com.ink.speaker.ai.service.KnowledgeBaseService;
import com.ink.speaker.ai.agent.LoreAgent;
import com.ink.speaker.ai.agent.WritingAssistantAgentFactory;
import com.ink.speaker.ai.agent.ChapterAgent;
import com.ink.speaker.ai.cache.LlmCacheService;
import com.ink.speaker.ai.core.skill.Skill;
import com.ink.speaker.ai.core.skill.SkillRegistry;
