package com.ink.speaker.config.async;
...
public class AsyncConfig {
    ...
    public ExecutorService sseStreamExecutor(
            @Value("${ink-speaker.async.sse.core-size:4}") int coreSize,
            @Value("${ink-speaker.async.sse.max-size:16}") int maxSize,
            @Value("${ink-speaker.async.sse.queue-capacity:64}") int queueCapacity,
            @Value("${ink-speaker.async.sse.keepalive-sec:60}") long keepAliveSec) {
    ...
    public Executor novelAsyncExecutor(
            @Value("${ink-speaker.async.novel.core-size:4}") int coreSize,
            @Value("${ink-speaker.async.novel.max-size:16}") int maxSize,
            @Value("${ink-speaker.async.novel.queue-capacity:100}") int queueCapacity,
            @Value("${ink-speaker.async.novel.keepalive-sec:60}") long keepAliveSec) {
