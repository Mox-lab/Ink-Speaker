 ...
 * </ul>
 *
 * <p>当配置 {@code ink.skill.enabled=false} 时,Skill 系统退化为
...
public class SkillRegistry {
    ...
    public SkillRegistry(
            List<Skill> skills,
            @Value("${ink.skill.enabled:true}") boolean enabled,
            @Value("${ink.skill.default-skill:default}") String defaultSkillId) {
        this.skills = skills;
