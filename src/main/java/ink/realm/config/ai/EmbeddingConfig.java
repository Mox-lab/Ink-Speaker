...
public class EmbeddingConfig {
    ...
    public EmbeddingStore<TextSegment> embeddingStore(
            ...
            @Value("${ink.pgvector.table}") String table,
            @Value("${ink.pgvector.dimension}") int dim,
            @Value("${ink.pgvector.use-index}") boolean useIndex,
            @Value("${ink.pgvector.index-list-size:100}") int indexListSize) {
