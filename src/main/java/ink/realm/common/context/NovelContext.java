package ink.realm.common.context;
...
import ink.realm.config.web.NovelContextFilter;

/**
 * 请求上下文(基于 ThreadLocal)。
 * <p>持有 novelId 与 userId,用于行级安全(R5 用户隔离)。</p>
 *
 * <p>填充入口:{@link NovelContextFilter}。</p>
 ...
 * 已通过 {@link AsyncConfig#novelContextTaskDecorator} 解决。</p>
 *
 * <p><b>R5 用户隔离:</b></p>
 * <ul>
